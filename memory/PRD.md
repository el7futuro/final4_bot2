...
### Расчёт счёта
**ИСПРАВЛЕННАЯ ФОРМУЛА (Декабрь 2025):**
...
**Примеры:**
- 3 отбития, 1 гол + 1 передача: перед→2 отб, гол съедает 2→0 отб = **0:0**
- 3 отбития, 2 гола: гол1→1 отб, гол2→0 отб = **0:0**
- 2 отбития, 3 гола: гол1→0 отб, гол2 проходит, гол3 проходит = **2:0**

**Формула:** `goals_scored = max(0, own_goals - ceil(remaining_saves / 2))`
